...
https://i.imgur.com/T59WAoT.gifv

GIF created with Recordit.

## Notes
Although they are not visible in the gif, the placeholder images are there for both orientations.
Describe any challenges encountered while building the app.

At one point, android studio stopped recognizing my resources folder, ie every instance of R.id.filename stopped working.
